...
import { ShieldCheck, Award, Globe, HeartPulse } from 'lucide-react';
...
export function DiamondStatsCard() {
    return (
        <div className="crystal-card p-10 h-full min-h-[280px] flex flex-col justify-center relative overflow-hidden group bg-slate-900/40">
            <div className="absolute inset-0 bg-gradient-to-r from-[#C5A059]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            <div className="grid grid-cols-2 gap-8 relative z-10 divide-x divide-white/10">
                {/* Stat 1 */}
                <div className="text-center px-4">
                    <p className="text-5xl font-black text-white mb-2 group-hover:text-[#C5A059] transition-colors">15+</p>
                    <p className="text-[#C5A059] text-[10px] font-black uppercase tracking-[0.2em] mb-1">Clinical Years</p>
...
export function GoldWarrantySeal() {
    return (
        <div className="crystal-card p-10 flex flex-col items-center justify-center text-center h-full min-h-[280px] relative overflow-hidden group bg-slate-900/40 border-[#C5A059]/20">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(197,160,89,0.1),transparent_70%)]" />

            {/* Premium Seal Badge */}
            <div className="relative mb-8 group-hover:scale-110 transition-transform duration-700">
                {/* Outer Ring */}
                <div className="w-24 h-24 rounded-full border-2 border-[#C5A059]/40 flex items-center justify-center p-1.5 shadow-[0_0_30px_rgba(197,160,89,0.2)] bg-slate-950/80">
                    {/* Inner Badge */}
                    <div className="w-full h-full rounded-full bg-gradient-to-br from-[#C5A059] via-[#B08D47] to-[#8C6D2D] flex items-center justify-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="inline-block px-4 py-1 rounded-full bg-[#C5A059]/10 border border-[#C5A059]/20 text-[#C5A059] text-[9px] font-black tracking-[0.2em] uppercase mb-4">
                    Lifetime Integrity
                </div>
