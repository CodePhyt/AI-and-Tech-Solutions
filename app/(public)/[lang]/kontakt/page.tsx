    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-24 space-y-12 min-h-[70vh]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* 1. WhatsApp Block */}
                <div className="p-8 bg-corporate-dark border border-white/5 rounded-2xl flex flex-col justify-between space-y-6 hover:border-corporate-blue transition-colors group">
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-2">{t.waTitle}</h2>
                        <p className="text-slate-400">{t.waDesc}</p>
                    </div>
                    <a href="https://wa.me/491713474348" target="_blank" rel="noopener noreferrer" className="block w-full text-center px-6 py-4 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold rounded-xl shadow-lg transition-all uppercase tracking-wider group-hover:scale-105">
                        {t.waBtn}
                    </a>
                </div>

                {/* 2. Phone Call Block */}
                <div className="p-8 bg-corporate-dark border border-white/5 rounded-2xl flex flex-col justify-between space-y-6 hover:border-corporate-silver transition-colors group">
                    <div>
                ...
                <div className="p-8 bg-corporate-dark border border-white/5 rounded-2xl flex flex-col justify-between space-y-6 hover:border-corporate-blue transition-colors group">
                    ...
                    <a href="mailto:osmankadirde@gmail.com" className="block w-full text-center px-6 py-4 bg-corporate-blue hover:bg-blue-600 text-white font-bold rounded-xl shadow-lg transition-all uppercase tracking-wider group-hover:scale-105">
                        {t.emailBtn}
                    </a>
                </div>
